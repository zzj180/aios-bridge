...
public class BridgeApplication extends Application{
 ...
 //   private boolean canResume;
    ...
    private boolean  registCommands(){
 ...
 //       commands.add(goHome);
        ...
        boolean success = AIOSCustomizeManager.getInstance().regCommands(commands);
        Logger.d("regCommands = " +success);
        return success;
    }
      ...
      //  canResume = false;
        ...
        if(acc){
            ...
            if ( PreferenceUtil.getFloat(this,"lat", 0f) != 0f &&  PreferenceUtil.getFloat(this,"lng", 0f) != 0f) {
                Intent windowService = new Intent(this, BridgeService.class);
